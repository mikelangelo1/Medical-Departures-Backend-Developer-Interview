...
async function bootstrap() {
  ...
  if (appConfig.isDev) {
    ...
    swaggerServers.push('https://api.medicaldepartures.app');

    const docBuilder = new DocumentBuilder()
      .setTitle('MEDICAL DEPARTURE INTERVIEW')
      .setDescription('MEDICAL DEPARTURE INTERVIEW Rest API')
      .setVersion('1.0.0')
      .addTag('medicalDepartures')
      .addBearerAuth()
      .addSecurity('devKey', {
        type: 'apiKey',
        name: 'x-dev-key',
    ...
    SwaggerModule.setup('openapi', app, document, {
      customSiteTitle: 'MEDICAL DEPARTURE INTERVIEW OpenAPI',
      swaggerOptions: {
